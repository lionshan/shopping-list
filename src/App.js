            ...
            <div className='container'>
                ...
                <form onSubmit={this.handleSubmit.bind(this)}>
                  ...
                  <div className="form-group ">
                    ...
                    <input type="number" min="1" step='0.01' className="form-control" id="price" placeholder="0" value={this.state.id}
                    onChange={this.handleChange.bind(this)}/>
                  </div>
                  <div className="form-group">
                    <label htmlFor="num">数量</label>
                    <input type="number" min="1" id="num" className="form-control" placeholder="0" value={this.state.id}
                    onChange={this.handleChange.bind(this)}/>
                  </div>
